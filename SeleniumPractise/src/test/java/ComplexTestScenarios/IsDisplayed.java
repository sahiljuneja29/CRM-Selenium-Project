...
public class IsDisplayed {
	...
	public void Test1() {
		...
		// "C:\\Users\\sahil.juneja01\\Desktop\\Study Material\\chromedriver.exe");
		System.setProperty("webdriver.chrome.driver",
				"C:\\Users\\sahil.juneja01\\Desktop\\chromedriver_win32 (7)\\chromedriver.exe");
...
//anything else will definitely go to NoSuchElementException. 
		...
		// Boolean Enable =
		// driver.findElement(By.xpath("//*[@id='multi-select-example-div']/fieldset/legend")).isEnabled();
